...
@Repository
//this annotation is optional since simpleJPARepository  class has already the repository annotation which implements jparepository and in terms it also implements user repository
